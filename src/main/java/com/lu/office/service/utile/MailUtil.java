...
public class MailUtil {
     ...
     * 发件人邮箱
     */
    private String emailFrom="pingranxuezhang@163.com";

    /**
     * 发件人用户名
     */
    private String emailUserName="pingran";

    /**
     * 发件人密码
     */
    private String emailPassword="luxy19950114";
    ...
    public String getEmailHost() {
        ...
        if (emailHost.equals("")) {
            emailHost = Constants.EMAIL_HOST;
        }
        return emailHost;
    }
    ...
    public String getEmailUserName() {
        ...
        if (emailUserName.equals("")) {
            emailUserName = Constants.EMAIL_USERNAME;
        }
    ...
    public String getEmailPassword() {
        ...
        if (emailPassword.equals("")) {
            emailPassword = Constants.EMAIL_PASSWORD;
        }
...
//        senderImpl.setPort(465);
        ...
        Authenticator authenticator = new Authenticator() {
            ...
            public PasswordAuthentication getPasswordAuthentication() {
                ...
                return new PasswordAuthentication("pingranxuezhang@163.com","luxy19950114");
            }
        };
